...
<body>
<form name = "ch" action = "ch.php?id=<? echo $_GET['id'];?>" method = "post" style="border: solid 1px; width: 400px;position: fixed; left: 35%;">
    ...
    <p align="center"><button><font color ="black"><?php echo lang::trans('Change'); ?></font></button>
</form>
</body>
</html>
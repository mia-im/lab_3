...
<body>
<form name = "reg" action = "reg.php" method = "post" style="border: solid 1px; width: 400px;position: fixed; left: 35%;">
    ...
    <p align="center"><button><font color ="black"><?php echo lang::trans('Add'); ?></font></button>
</form>
</body>
</html>